...
if stack in ("android", "multi"):
    paths += [
        f"app/src/main/java/com/multiappshare/{feature}",
        f"app/src/main/java/com/multiappshare/ui/{feature}",
        f"feature-dashboard/src/main/java/com/multiappshare/{feature}",
        f"core-domain/src/main/java/com/multiappshare/{feature}",
        f"core-database/src/main/java/com/multiappshare/{feature}",
    ]
