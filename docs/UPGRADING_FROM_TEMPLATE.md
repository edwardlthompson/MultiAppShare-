...
- After cherry-picks: run ash scripts/validate-bootstrap.sh --quick and ash scripts/feature-gate.sh --stack android.
- Alignment record: [docs/BOOTSTRAP_ALIGNMENT.md](BOOTSTRAP_ALIGNMENT.md).
